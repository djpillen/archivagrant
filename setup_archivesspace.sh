...
PLUGINS="AppConfig[:plugins] = ['timewalk', 'bhl_aspace_translations', 'bhl-ead-importer','bhl-ead-exporter','aspace-jsonmodel-from-format','donor_details', 'generate_bhl_identifiers']"
